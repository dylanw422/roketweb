...
function HeroTitles() {
  return (
    <div className="flex w-full max-w-2xl flex-col space-y-4 overflow-hidden pt-8">
      ...
      >
        {["Stop", "Applying,", "Start", "Getting", "Hired"].map(
          (text, index) => (
            <motion.span
              key={index}
      ...
      >
        Guaranteed to help you land your dream job faster
      </motion.p>
    </div>
  );
}
...
function HeroImage() {
  return (
    ...
    >
      <img className="w-2/3 mt-5" src="/roketDashboard.png" alt="Dashboard" />
    </motion.div>
  );
}
